  ...
  return (
    <div>
      ...
      <div className="fixed inset-0 z-40 flex items-center justify-center bg-black bg-opacity-50">
        <section className="w-full max-w-md p-6 mx-auto bg-white rounded-lg shadow-lg dark:bg-gray-800 relative">
          ...
          <ul className="grid gap-2">
            ...
            <li className="mt-1 text-gray-400 dark:text-gray-300 flex flex-col">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <button
                type="button"
                className="w-full px-4 py-2 mt-4 text-white bg-red-500 hover:bg-red-700 duration-150 rounded-lg focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:focus:ring-red-800"
